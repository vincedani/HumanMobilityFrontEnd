package hu.daniel.vince.humanmobility.view.drawable;
...
public class ProgressDrawable extends Drawable implements Animatable {
    ...
    public ProgressDrawable(int color, float borderWidth) {
    ...
    private final Property<ProgressDrawable, Float> mAngleProperty =
            new Property<ProgressDrawable, Float>(Float.class, "angle") {
        @Override
        public Float get(ProgressDrawable object) {
            return object.getCurrentGlobalAngle();
        }

        @Override
        public void set(ProgressDrawable object, Float value) {
            object.setCurrentGlobalAngle(value);
        }
    };

    private final Property<ProgressDrawable, Float> mSweepProperty =
            new Property<ProgressDrawable, Float>(Float.class, "arc") {
        @Override
        public Float get(ProgressDrawable object) {
